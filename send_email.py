...
def load_top_news(json_file: str = "top_news.json"):
    ...
    try:
        ...
        print(f"✗ Error loading top news: {e}")
        return []
...
def create_html_email(news_items: list):
    """Create styled HTML email with animations."""
...
def send_email(news_items: list, recipient_email: str):
    """Send HTML email with top news."""
    ...
    try:
        ...
        # Create HTML content
        html_content = create_html_email(news_items)
...
if __name__ == "__main__":
    ...
    # Send email
    success = send_email(news_items, recipient_email)
