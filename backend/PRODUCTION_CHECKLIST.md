...
- `RESEND_API_KEY` - Resend API key for sending emails (get from [resend.com](https://resend.com))
- `SENDER_EMAIL` - Email address for sending newsletters (defaults to `ainews@prajwolsubedi.com.np`)
...
- `REPLY_TO_EMAIL` - Reply-to email address (defaults to `prajwolsubedi@gmail.com`)
...
2. **Email Sending Fails**
   ...
   - Verify `SENDER_EMAIL` matches your verified domain
